...
- Widgets com listas roláveis nativas (ex.: a agenda do Google
  ...
  vertical antes da lista nativa (uma `ListView` clássica) ter chance
  de rolar sozinha. Adicionado `NestedScrollInteropConnection`, a ponte
  oficial do Compose para Views antigas que coordenam rolagem pelo
  mecanismo de interceptar toque (em vez da API de nested scrolling
  mais nova).
