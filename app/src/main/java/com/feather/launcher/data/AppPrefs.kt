 ...
 * destaque personalizada, visualização da Gaveta (lista/grade), a
 * lista de Spaces (padrão + personalizados) e o vínculo (exclusividade)
 * de apps por Space. Usa SharedPreferences por ser síncrono, simples e
 * suficiente para estes volumes pequenos de dados — não justifica o
 * custo de inicialização do DataStore aqui.
 */
