...
enum class ContextMode(val label: String, val subtitle: String) {
    DIA_A_DIA(
        label = "Dia a Dia",
        subtitle = "Comunicação, mídia e utilitários em destaque."
    ),
    TRABALHO(
        label = "Trabalho",
        subtitle = "Produtividade e comunicação priorizadas no topo."
    ),
    NOITE(
        label = "Noite",
        subtitle = "Mídia e utilitários em destaque \u2014 considere o tema AMOLED."
    )
}
