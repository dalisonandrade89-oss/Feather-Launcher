...
/**
 * NOVA FUNCIONALIDADE: seletor de aparência (Escuro / Claro / AMOLED).
 * A seleção é repassada ao ViewModel, que persiste em AppPrefs
 * (SharedPreferences) e sobrevive a reinícios do launcher.
 */
@Composable
